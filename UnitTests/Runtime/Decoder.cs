...
namespace UnitTests
{
	public class DecoderTests
	{
		...
		private const byte MasterIndirectionSize0 = 0b000_00_000;
		private const byte MasterIndirectionSize8 = 0b001_00_000;
		private const byte MasterIndirectionSize16 = 0b010_00_000;
		private const byte MasterIndirectionSize32 = 0b011_00_000;
		private const byte MasterIndirectionSize64 = 0b100_00_000;
		private const byte MasterIndirectionSizeUnused1 = 0b101_00_000;
		private const byte MasterIndirectionSizeUnused2 = 0b110_00_000;
		private const byte MasterIndirectionSizeUnused3 = 0b111_00_000;
		private const byte MasterAddressingModeA = 0b000_00_000;
		private const byte MasterAddressingModeAB = 0b000_01_000;
		private const byte MasterAddressingModeCD = 0b000_10_000;
		private const byte MasterAddressingModeABCD = 0b000_11_000;
		private const byte MasterSegmentNone = 0b000_00_000;
		private const byte MasterSegmentSS = 0b000_00_001;
		private const byte MasterSegmentCD = 0b000_00_010;
		private const byte MasterSegmentDS = 0b000_00_011;
		private const byte MasterSegmentES = 0b000_00_100;
		private const byte MasterSegmentFS = 0b000_00_101;
		private const byte MasterSegmentGS = 0b000_00_110;
		private const byte MasterSegmentXS = 0b000_00_111;
		private const int ControlARegIdShift = 2; // 0b011111_00
		private const int ControlARegIdSize8 = 0b000000_00;
		private const int ControlARegIdSize16 = 0b000000_01;
		private const int ControlARegIdSize32 = 0b000000_10;
		private const int ControlARegIdSize64 = 0b000000_11;
